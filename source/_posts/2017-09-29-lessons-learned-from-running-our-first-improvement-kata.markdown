...
We also learned that [retrospective](/blog/categories/retrospectives/) is not the only road to continuous improvement. In fact, the improvement kata and retrospectives are very different :
