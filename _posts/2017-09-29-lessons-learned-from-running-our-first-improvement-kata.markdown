...
We also learned that [retrospective]({{site.baseurl}}/categories/#retrospectives) is not the only road to continuous improvement. In fact, the improvement kata and retrospectives are very different :
